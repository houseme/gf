...
require (
	...
	github.com/gogf/gf/contrib/configure/polaris/v2 v2.0.0-00010101000000-000000000000
...
replace (
	...
	github.com/gogf/gf/contrib/configure/polaris/v2 => ../contrib/configure/polaris/
